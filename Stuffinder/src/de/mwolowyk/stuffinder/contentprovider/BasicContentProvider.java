...
public abstract class BasicContentProvider extends ContentProvider {
	...
	protected abstract boolean isSearchEntity(Uri uri);
	protected abstract String getBasicPath();
	protected abstract SQLiteQueryBuilder getQueryBuilder(Uri uri);
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		if (!isSingleEntity(uri)) {
			...
			if (TextUtils.isEmpty(selection)) {
				...
				rowsDeleted = sqlDB.delete(tableName, CustomTable.ID + "=" + id
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		if (!isSingleEntity(uri)) {
			...
			if (TextUtils.isEmpty(selection)) {
				rowsUpdated = sqlDB.update(tableName, values, CustomTable.ID
						+ "=" + id, null);
			} else {
				rowsUpdated = sqlDB.update(tableName, values, CustomTable.ID
